...
ggplot(subset(gapminder, year == 1952), aes(gdpPercap, lifeExp, size = pop)) +
  ...
  theme(text=element_text(size=18),
        axis.title.y=element_text(angle=30))
...
Because it gives us an even x-axis that can contain and show large sums with a better distribution. 
...
anim <- ggplot(gapminder, aes(gdpPercap, lifeExp, size = pop/1000000)) +
  ...
  labs(x="GDP per capita",y="life expencancy")
anim
```
...
We cannot answer this question with this dataset, because there is no data from the year I was born, which is 2000, and the dataset stop in 2007, so we also don't have information from 2026.
